...
def init(client_instance):
    ...
    quickhelp_description = "⚡ Shona user bot Help System - Complete guide to using the advanced help features"
...
async def register_commands():
    ...
    async def help_handler(event):
        ...
        if plugin_name:
            ...
            if plugin_name in CMD_LIST:
                ...
                help_text = f"🎭 <b>Shona userbot  - {plugin_name.title()} Plugin</b>\n"
                help_text += f"━━━━━━━━━━━━━━━━━━━━━━\n"
                ...
                help_text += f"🤖 <b>Powered by shona bots</b>"
                ...
                error_text = f"🎭 <b>SHONA USERBOT Help System</b>\n\n"
    ...
    async def list_plugins(event):
        try:
            if not CMD_LIST:
                await event.reply("🎭 <b>SHONA USERBOT Plugin Manager</b>\n\n"
            ...
            plugins_text = f"🎭 <b>SHONA BOT Loaded Plugins</b>\n"
            plugins_text += f"━━━━━━━━━━━━━━━━━━━━━━\n"
            ...
            plugins_text += f"🤖 <b>Powered by @SHONA_BOTS</b>"
    ...
    async def find_plugin(event):
        try:
            ...
            if not search_term:
                await event.reply("🔍 <b>SHONA USERBOT Plugin Search</b>\n\n"
            ...
            if not matches:
                await event.reply(f"🔍 <b>SHONA USERBOT Plugin Search</b>\n\n"
    ...
    async def help_stats(event):
        try:
            ...
            stats_text = f"📊 <b>SHONA USERBOT Help Statistics</b>\n"
            stats_text += f"━━━━━━━━━━━━━━━━━━━━━━\n"
            ...
            stats_text += f"🤖 <b>Powered by @SHONA_BOTS</b>"
    ...
    async def quick_help_guide(event):
        try:
            guide_text = f"⚡ <b>SHONA USERBOT Quick Help Guide</b>\n"
            guide_text += f"━━━━━━━━━━━━━━━━━━━━━━\n\n"
            ...
            guide_text += f"🤖 <b>Powered by @SHONA_BOTS</b>"

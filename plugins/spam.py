...
async def register_commands():
    ...
    async def cipher_elite_spam(event):
        try:
            ...
            if count <= 0 or count > 500:
                await event.reply("🎭 **Shona Elite Spam Engine**\n\n"
                                "❌ **Invalid count!** Use 1-500\n"
                                "💡 **Usage:** `.spam 10 Hello World`")
                return
            
            if not message_content:
                await event.reply("❌ **Shona Elite Error:** Please provide message content!")
                return
            ...
            status_msg = await event.reply(f"🎭 **Shona Elite Spam Engine**\n\n"
            ...
            await status_msg.edit(f"🎭 **Shona Elite Spam Complete**\n\n"
                                 f"💥 **Operation:** TEXT SPAM\n"
            ...
            await event.reply("🎭 **Shona Elite Spam Error**\n\n"
                            "❌ **Invalid number format!**\n"
                            "💡 **Usage:** `.spam 10 Hello World`")
        except Exception as e:
            await event.reply(f"🎭 **Shona Elite Spam System Error**\n\n"
                            f"❌ **Error:** {str(e)[:100]}...")
    ...
    async def cipher_elite_delay_spam(event):
        try:
            ...
            if count <= 0 or count > 200:
                await event.reply("🎭 **Shona Elite Delay Spam Engine**\n\n"
            ...
            status_msg = await event.reply(f"🎭 **Shona Elite Delay Spam Engine**\n\n"
            ...
            await status_msg.edit(f"🎭 **Shona Elite Delay Spam Complete**\n\n"
                                 f"💥 **Operation:** DELAY SPAM\n"
                                 f"✅ **Sent:** {sent_count}/{count} messages\n"
            ...
            await event.reply("🎭 **Shona Elite Delay Spam Error**\n\n"
                            "❌ **Invalid format!**\n"
                            "💡 **Usage:** `.dspam 10 2.5 Hello World`\n"
                            "📝 **Format:** count delay(seconds) message")
        except Exception as e:
            await event.reply(f"🎭 **Shona Elite System Error**\n\n"
                            f"❌ **Error:** {str(e)[:100]}...")
    ...
    async def cipher_elite_media_spam(event):
        try:
            ...
            if not event.reply_to_msg_id:
                await event.reply("🎭 **Shona Elite Media Spam Engine**\n\n"
            ...
            status_msg = await event.reply(f"🎭 **Shona Elite Media Spam Engine**\n\n"
            ...
            await status_msg.edit(f"🎭 **Shona Elite Media Spam Complete**\n\n"
                                 f"💥 **Operation:** MEDIA SPAM\n"
                                 f"📸 **Type:** {media_type}\n"
            ...
            await event.reply(f"🎭 **Shona Elite Media Spam Error**\n\n"
                            f"❌ **Error:** {str(e)[:100]}...")
    ...
    async def cipher_elite_stop_spam(event):
        try:
            ...
            if chat_id not in cipher_spam_tasks or not cipher_spam_tasks[chat_id]:
                await event.reply("🎭 **Shona Elite Spam Control**\n\n"
    ...
    async def cipher_elite_list_spam(event):
        try:
            if not cipher_spam_tasks:
                await event.reply("🎭 **Shona Elite Spam Monitor**\n\n"
                                "✅ **No active spam operations detected**\n"
                                "🛡️ **All systems clear**\n"
                                "📊 **Status:** IDLE MODE")
                return
            
            list_msg = f"🎭 **Shona Elite Active Operations**\n\n"
            ...
            list_msg += f"🤖 **Shona Elite Monitoring System**"
    ...
    async def cipher_elite_spam_stats(event):
        try:
            ...
            stats_msg = f"🎭 **Shona Elite Spam Engine Statistics**\n\n"

...
def add_handler(plugin_name, commands, description=""):
    ...
    if plugin_name not in CMD_LIST:
        ...
        # Debug Log
        print(f"🎭 Shona Elite: Registered '{plugin_name}' ({len(CMD_LIST[plugin_name]['commands'])} cmds)")
...
def remove_handler(plugin_name):
    ...
    try:
        if plugin_name in CMD_LIST:
            ...
            print(f"🗑 Shona Elite: Removed '{plugin_name}' from Help Menu.")
            return True
        ...
        if data.startswith("plugin_"):
            ...
            if plugin_name in CMD_LIST:
                ...
                if plugin_name == "quickhelp":
                    text = (
                        f"⚡ <b>SHONA USERBOT Quick Help</b>\n"
                        f"━━━━━━━━━━━━━━━━━━━━━━\n\n"
